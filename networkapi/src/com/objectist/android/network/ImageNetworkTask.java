...
public class ImageNetworkTask extends AbstractNetworkTask {

	@SuppressWarnings("unused")
	private static final String CLASS_NAME = ImageNetworkTask.class.getSimpleName();
	...
	public ImageNetworkTask(NetworkRequest request, NetworkTaskListener listener, Object requestId) {
...
Log.v("ronj", "exception e" + e.getMessage());
	...
	public String toString() {
		return "[" + ImageNetworkTask.class.getSimpleName() + "]";
	}
